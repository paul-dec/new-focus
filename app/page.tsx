...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-4 lg:p-10">
      ...
      <Pricing text1='Tarification' text2='Utilisez notre service pour produire du contenu en masse.' text3='Basic' text4='4900€/mois' text5='Pause ou annulation à tout moment' text6='2 demandes traitées à la fois' text7='Inclus :' text8='Graphisme / Montage / Motion Design' text9='2 demandes traitées à la fois' text10='Temps moyen de traitement de 72h' text11='Retours / Déclinaisons / Traductions illimités' text12='Nombre d’utilisateurs et de marques illimités' text13='Pause ou arrêt de l’abonnement à tout moment' text14='Réserver  un  appel' text15='Pro' text16='7900€/mois' text17='Pause ou annulation à tout moment' text18='3 demandes traitées à la fois (avec de l’UGC)' text19='Inclus :' text20='Graphisme / Montage / Motion Design / UGC' text21='3 demandes traitées à la fois' text22='Temps moyen de traitement de 48 à 72h' text23='Retours / Déclinaisons / Traductions illimités' text24='Nombre d’utilisateurs et de marques illimités' text25='Pause ou arrêt de l’abonnement à tout moment' text26='Réserver  un  appel' />
