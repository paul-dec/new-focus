...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-4 lg:p-10">
      ...
      <Header text1='L’agence créative' text2='par ' text3='abonnement' text4='Du contenu' text5='performant et adapté à vos besoins' text6='en moins de' text7='48h.' text8='Pause ou annulation à tout moment.'text9='Nos abonnements' />
