...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-4 lg:p-10">
      ...
      <Header text1='L’agence créative' text2='par ' text3='abonnement' text4='Du contenu adapté à vos besoins' text5='et performant' text6='en moins de' text7='48h.' text8='Sans engagement. Pause ou annulation à tout moment.'text9='Nos  abonnements' />
      ...
      <Pricing text1='Tarification' text2='Utilisez notre service pour produire du contenu en masse.' text3='Basic' text4='4900€/mois' text5='Pause ou annulation à tout moment' text6='2 demandes traitées à la fois' text7='Inclus :' text8='2 demandes traitées à la fois, un chef de projet dédié' text9='Graphisme / Montage / Motion Design / UGC' text10='Temps moyen de traitement de 48 à 72h' text11='Retours / Déclinaisons / Traductions illimités' text12='Nombre d’utilisateurs / marques illimités' text13='Pause ou arrêt de l’abonnement à tout moment' text14='Réserver  un  appel' text15='Pro' text16='7900€/mois' text17='Pause ou annulation à tout moment' text18='3 demandes traitées à la fois' text19='Inclus :' text20='3 demandes traitées à la fois, un chef de projet dédié' text21='Graphisme / Montage / Motion Design / UGC' text22='Temps moyen de traitement de 48 à 72h' text23='Retours / Déclinaisons / Traductions illimités' text24='Nombre d’utilisateurs / marques illimités' text25='Pause ou arrêt de l’abonnement à tout moment' text26='Réserver  un  appel' />
      <Faq text1='FAQ' text2='Quand vais-je recevoir mes contenus&nbsp;?' text3='Nous traitons en moyenne toutes les demandes en 48 à 72h en vous tenant informé. Pour les demandes plus complexes comme les UGC, les délais sont légèrement allongés pour permettre à l’acteur de tourner dans de bonnes conditions.' text4='Comment faire une demande pour un nouveau contenu&nbsp;?' text5='Nous utilisons Notion pour traiter vos demandes. Vous êtes libre d’écrire votre brief directement sur Notion ou de nous transmettre un Loom, un Google Doc, ou n’importe quel support qui nous aide à comprendre vos idées.' text6='Pourquoi mettre en pause mon abonnement&nbsp;?' text7='Tous les mois ne se ressemblent pas pour votre activité : nous avons mis en place la possibilité de mettre en pause votre abonnement et de le réactiver à tout moment.' text8='Pourquoi ne pas embaucher une équipe créative à temps plein&nbsp;?' text9='Notre volonté est de mettre à disposition de chaque entreprise un véritable studio créatif en interne, bien loin du coût annuel d&apos;une telle équipe. De plus, votre nombre de demandes peut varier et grâce à notre abonnement, vous pourrez mettre en pause à tout moment, pour reprendre lorsque vous avez assez de demandes.' />
      <Start text1='Réserver un appel' text2='20mn pour rencontrer nos équipes' />
      <BottomBar text1='Agence créative basée à Nice (ceci vaut invitation pour un café dans nos bureaux)' text2='© 2025 Focus' text3='Mentions légales' />
    </main>
  )
}
