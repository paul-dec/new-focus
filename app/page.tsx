...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-4 lg:p-10">
      ...
      <Brands />
      <Timeline text1='Comment ça marche&nbsp;?' text2='Inscription' text3='Choisissez l'une de nos formules et faites autant de demandes que vous le souhaitez.' text4='Production' text5='Nous traitons vos demandes pour vous livrer les contenus en 48 à 72h.' text6='Traductions et retours&nbsp;illimités' text7='Jusqu’à vous satisfaire à 100%.' />
