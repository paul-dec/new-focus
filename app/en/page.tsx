...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-4 lg:p-10">
      <Navbar text1='How does it work?' text2='Pricing' text3='FAQ' text4='Click to book a call' />
      ...
      <Brands />
      <Timeline text1='How does it work?' text2='Inscription' text3='Choose one of our two plans and make as many requests as you like.' text4='Production' text5='We process your requests and deliver content within 72 hours on average.' text6='Unlimited&nbsp;returns' text7='Until you&apos;re 100% satisfied.' />
      ...
      <BottomBar text1='A creative agency in Nice, France' text2='© 2023 Focus' />
    </main>
  )
}
