  ...
  return (
    <div className="flex lg:grid grid-cols-3 w-full">
      ...
      <div className="hidden lg:flex items-center justify-end	">
        <a href="https://cal.com/robin-focus/call" target="_blank" className="px-8 py-4 border border-light-tertiary hover:border-tertiary transition-colors	 bg-light-secondary rounded-lg text-center font-roboto">Cliquer pour réserver un appel</a>
      </div>
    </div>
  )
}
