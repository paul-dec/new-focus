    ...
    <div id="pricing" className="flex flex-col justify-center items-center gap-20 py-24 lg:py-36">
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-20 lg:gap-10">
        <div className="flex flex-col px-10 py-10 gap-2 max-w-[500px] w-full bg-light-secondary rounded-xl">
          ...
          <a href="https://cal.com/robin-focus/offre-illimitee" target="_blank" className="flex w-fit mt-4 px-8 py-4 bg-white rounded-lg text-black font-bold hover:scale-105 transition-transform uppercase">{text14}</a>
        </div>
        <div className="flex flex-col px-10 py-10 gap-2 max-w-[500px] w-full bg-tertiary rounded-xl">
          ...
          <a href="https://cal.com/robin-focus/offre-illimitee" target="_blank" className="flex w-fit mt-4 px-8 py-4 bg-primary rounded-lg text-tertiary font-bold hover:scale-105 transition-transform uppercase">{text26}</a>
        </div>
      </div>
    </div>
  )
