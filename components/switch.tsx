    ...
    <div className="flex flex-col justify-center items-center gap-20 py-24 lg:py-36 max-w-5xl">
      <div className="flex flex-col sm:flex-row gap-20 xl:translate-x-10">
        <div className="flex flex-col gap-4">
          ...
          <a href="https://cal.com/robin-focus/book-a-call" target="_blank" className="flex w-fit mt-4 px-8 py-4 bg-white rounded-lg text-black font-bold hover:scale-105 transition-transform uppercase">{text4}</a>
        </div>
      ...
      <div className="flex flex-col-reverse sm:flex-row gap-20 xl:-translate-x-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a href="https://cal.com/robin-focus/book-a-call" target="_blank" className="flex w-fit mt-4 px-8 py-4 bg-white rounded-lg text-black font-bold hover:scale-105 transition-transform uppercase">{text8}</a>
        </div>
      </div>
    </div>
  )
