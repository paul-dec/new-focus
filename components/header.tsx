  ...
  return (
    <div className="flex flex-col justify-center gap-10 lg:gap-20 py-24 lg:py-36">
      <div className="flex flex-col justify-center">
        <h1 className="text-center text-3xl lg:text-6xl font-bold uppercase">Du contenu (en illimité) pour</h1>
        <div className="flex flex-col justify-center items-center relative h-[80px] lg:h-[140px] overflow-hidden	">
          <h1 className="top-[-1px] absolute text-center text-3xl lg:text-6xl font-bold leading-[40px] lg:leading-[70px] uppercase animate-header-loop-mobile lg:animate-header-loop"><p className="text-primary">faire&nbsp;exploser&nbsp;vos<br/>réseaux&nbsp;sociaux</p>sur-performer&nbsp;en<br/>campagne&nbsp;ads<br/><p className="text-primary">alimenter&nbsp;votre<br/>site</p>créer&nbsp;du&nbsp;contenu<br/>en&nbsp;masse<br/><p className="text-primary">faire&nbsp;exploser&nbsp;vos<br/>réseaux&nbsp;sociaux</p></h1>
        </div>
      </div>
