export default async function Header() {
  return (
    <div className="flex flex-col justify-center gap-10 lg:gap-20 py-24 lg:py-44">
      ...
      <h2 className="text-center text-2xl font-medium font-roboto"><span className="opacity-80">Du contenu</span> <span className="text-primary">(</span><span className="opacity-80">en illimité</span><span className="text-primary">)</span> <span className="opacity-80">pour</span> <span className="text-primary">sur-performer</span><br/><span className="opacity-80">sur les réseaux sociaux et en campagne publicitaire.</span></h2>
