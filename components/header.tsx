  ...
  return (
    <div className="flex flex-col justify-center gap-10 lg:gap-20 py-24 lg:py-44">
      <div className="flex flex-col justify-center">
        <h1 className="text-center text-3xl lg:text-6xl font-bold uppercase">L’agence créative<br/>par <span className="text-primary">abonnement</span></h1>
      ...
      <h2 className="text-center text-lg lg:text-2xl font-medium font-roboto"><span className="opacity-80">Du contenu</span> <span className="text-primary">(</span><span className="opacity-80">en illimité</span><span className="text-primary">)</span> <span className="opacity-80">pour</span> <span className="text-primary">sur-performer</span><br/><span className="opacity-80">sur les réseaux sociaux et en campagne publicitaire.</span></h2>
